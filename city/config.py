...
ZOMBIE_WANDER_DIRECTION_CHANGE_PROBABILITY = 0.00002
ZOMBIE_KILL_PROBABILITY = 0.5
ZOMBIE_WOUND_PROBABILITY = 0.999
ZOMBIE_DESTRUCTION_PROBABILITY = 0.005

INFECTED_PANIC_TIME_MULTIPLIER = 2
INFECTED_INCUBATION_MAX_TIME = 1000

SURVIVOR_SPEED = 5
SURVIVOR_PANIC_RANGE = 100
SURVIVOR_PANIC_SPEED = 10
SURVIVOR_SEES_DEATH_PANIC_PROBABILITY = 0.9
SURVIVOR_SEES_PANICKED_OR_INFECTED_PANIC_PROBABILITY = 0.01
SURVIVOR_PANIC_DURATION = 250
